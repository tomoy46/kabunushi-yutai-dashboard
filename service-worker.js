const CACHE='yutai-dashboard-v1';const ASSETS=['./','index.html','styles.css','app.js','manifest.webmanifest','icons/icon.svg','data/benefits.json','data/market-data.json','data/update-status.json'];
